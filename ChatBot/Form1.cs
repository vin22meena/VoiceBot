...
namespace ChatBot
{
    public partial class ChatBot : Form
    {
        ...
        public void Restart()
        {
            ...
            Process.Start(@"C:\Users\User\Desktop\MyProject\ChatBot\ChatBot\bin\Debug\ChatBot.exe");
            Environment.Exit(0);
        }
        ...
        private void r_SpeechRecognized(object sender, SpeechRecognizedEventArgs e)
        {
            ...
            if (Search_Youtube)
            {
                Process.Start("https://www.youtube.com/results?search_query=" + result);
